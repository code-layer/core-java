...
public class SortBasedOnState
{
    public static void main(final String[] args) {
        ...
        final SortedSet dataSet = new TreeSet();
        dataSet.add(sci1);
        dataSet.add(sci2);
        dataSet.add(sci3);
        System.out.println("Geo Data : " + dataSet);
        System.out.println(" *** Geo Data using Iterator : Sort on State Name *** ");
